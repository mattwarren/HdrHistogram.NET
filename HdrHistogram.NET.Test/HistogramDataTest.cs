...
namespace HdrHistogram.NET.Test
{
    ...
    public class HistogramDataTest 
    {
        ...
        static /*final*/ /*Histogram*/ AbstractHistogram postCorrectedHistogram;
        static /*final*/ /*Histogram*/ AbstractHistogram postCorrectedScaledHistogram;
        ...
        public void testGetValueAtPercentileForLargeHistogram() 
        {
            ...
            Assert.assertTrue(h.getHistogramData().getValueAtPercentile(100.0) > 0);
        }
        ...
        {
            foreach (HistogramIterationValue v  in histogram.getHistogramData().percentiles(5 /* ticks per half */)) 
            {
        ...
        public void testLinearBucketValues()  
        {
            ...
            foreach (HistogramIterationValue v in histogram.getHistogramData().linearBucketValues(10000))
            {
                long countAddedInThisBucket = v.getCountAddedInThisIterationStep();
                if (index == 0) 
                {
            ...
            foreach (HistogramIterationValue v in histogram.getHistogramData().linearBucketValues(1000)) 
            {
                long countAddedInThisBucket = v.getCountAddedInThisIterationStep();
                if (index == 0) 
                {
        ...
        public void testLogarithmicBucketValues()  
        {
            ...
            foreach (HistogramIterationValue v in histogram.getHistogramData().logarithmicBucketValues(10000, 2)) 
            {
                long countAddedInThisBucket = v.getCountAddedInThisIterationStep();
                if (index == 0) {
